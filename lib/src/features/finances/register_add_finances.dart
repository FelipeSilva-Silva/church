...
class RegisterFinances extends StatefulWidget {
  const RegisterFinances({
    super.key,
    this.finance,
  });
  ...
  @override
  State<RegisterFinances> createState() => _RegisterFinancesState();
}

class _RegisterFinancesState extends State<RegisterFinances> {
